...
//     Console.WriteLine($"Mix number is {num2}");
// }
// else
// {
//     Console.WriteLine($"Max number is {num2}");
//     Console.WriteLine($"Mix number is {num1}");
// }
...
// Console.Write("Input number more 1: ");
// int num = Convert.ToInt32(Console.ReadLine());
// if(num <= 1) Console.WriteLine("Invalid number: " + num);
